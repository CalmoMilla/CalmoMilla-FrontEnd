...
export default function PaginaVideoRelaxamento() {

  return (
    <div className="w-full h-[100vh] bg-roxo relative">
      <h1 className="text-center text-branco font-calistoga text-3xl md:text-5xl py-10">Meditação Bla Bla Bla</h1>
      <iframe
        width="800"
        height="600"
        src={`https://www.youtube.com/embed/a1i5rgjunpw?si=-ldZIM_bbBmZq6rj`}
      ...
      <IoIosArrowDropleftCircle className="absolute top-5 left-5 text-3xl md:text-5xl text-branco hover:scale-110 duration-500 ease-in-out cursor-pointer"/>
    </div>
  )
}