...
export default function PaginaVideoRelaxamento({ video, funcao }) {
  ...
  return (
    <div className="w-full h-fit bg-roxo relative pt-32">
      <h1 className="text-center text-branco font-calistoga text-3xl md:text-5xl py-10 w-[80%] mx-auto">{video && video.titulo}</h1>
      <iframe
        width="800"
        height="600"
      ...
      ></iframe>
      <p className="text-center text-branco text-xl md:text-3xl py-10 w-[80%] mx-auto">{video && video.descricao}</p>
