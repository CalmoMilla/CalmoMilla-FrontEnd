...
export default function Psicologo(props) {
    ...
    const nomeAbreviado = abbreviateName(props.nome);
    ...
    return (
        ...
        <div className="w-full h-[45%] py-2 px-5">
          ...
          <p className="font-nunito text-xl">{props.idade ? props.idade : ""}</p>
          <p className="font-nunito text-xl">{props.cidade ? props.cidade : ""}</p>
        </div>
      </div>
    )
}