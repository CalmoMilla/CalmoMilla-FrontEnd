  ...
  useEffect(() => {
    const modalContent = (
      <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-50 z-50">
        <div className="xs:w-[80%] xs:h-[95%] overflow-y-auto  md:w-[600px]    bg-white rounded-lg p-4 absolute">
            ...
            <div className=" w-[90%] h-[90%] flex flex-col items-center justify-center mx-auto ">
              <div className="flex-col flex md:w-[90%] xs:w-[100%] h-full">
                <div className="grid grid-cols-2 gap-4">
                  <Emocao
                    funcao={handleRadioCalmo}
                    state={checkedCalmo}
                    emoji={"\u{1F642}"}
                    texto={"Calmo"}
                  />
                  <Emocao
                    funcao={handleRadioIrritado}
                    state={checkedIrritado}
                    emoji={"\u{1F620}"}
                    texto={"Irritado"}
                  />
                  <Emocao
                    funcao={handleRadioDesanimado}
                    state={checkedDesanimado}
                    emoji={"\u{1F61E}"}
                    texto={"Desanimado"}
                  />
                  <Emocao
                    funcao={handleRadioTristeza}
                    state={checkedTristeza}
                    emoji={"\u{1F622}"}
                    texto={"Tristeza"}
                  />
                  <Emocao
                    funcao={handleRadioAnsioso}
                    state={checkedAnsioso}
                    emoji={"\u{1F623}"}
                    texto={"Ansioso"}
                  />
                  <Emocao
                    funcao={handleRadioFeliz}
                    state={checkedFeliz}
                    emoji={"\u{1F60A}"}
                    texto={"Feliz"}
                  />
                  <Emocao
                    funcao={handleRadioAlegre}
                    state={checkedAlegre}
                    emoji={"\u{1F61D}"}
                    texto={"Alegre"}
                  />
                  <Emocao
                    funcao={handleRadioTedio}
                    state={checkedTedio}
                    emoji={"\u{1F644}"}
                    texto={"Tédio"}
                  />
                  <Emocao
                    funcao={handleRadioNeutro}
                    state={checkedNeutro}
                    emoji={"\u{1F610}"}
                    texto={"Neutro"}
                  />
                ...
                <div className="w-full justify-center flex my-5">
                  <button
                    ...
                    className="w-[60%] h-12 bg-amarelo1 hover:bg-amarelo2 duration-500 ease-in-out justify-center p-0 rounded-full text-white text-xl md:mb-3"
                    type="submit"
                  >
                    Submeter
                  </button>
