  ...
  return (
    <div className="w-[70%] lg:w-[50%] h-auto border-solid border-2 border-roxo rounded-3xl mb-10">
      <div className="w-full h-20 bg-roxo rounded-t-2xl flex justify-start pl-10 items-center">
        <h2 className="text-branco text-3xl font-nunito">
          {t("rotinaTitulo")}
        </h2>
      </div>
      {tarefas &&
      ...
      {mostrarTarefa && (
        <div className="flex justify-center items-center w-full">
          <button
            className="mx-auto bg-roxo/50 hover:bg-roxo hover:text-branco duration-500 ease-in-out font-nunito rounded-full w-[90%] md:w-[50%] text-xl py-4 mb-5"
            onClick={handleSubmitRotina}
          >
            {t("concluirRotinaDia")}
          </button>
        </div>
