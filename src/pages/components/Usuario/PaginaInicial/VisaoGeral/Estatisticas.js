  ...
  return (
    <>
      <div className="pt-2 m-auto md:p-8 w-[80%] md:w-auto">
        <h1 className="text-3xl md:text-5xl font-nunito text-amarelo2 text-center">Visão Geral</h1>
        <h2 className="text-2xl md:text-3xl font-nunito text-amarelo1 text-center pt-10">Suas estatísticas</h2>
      </div>
