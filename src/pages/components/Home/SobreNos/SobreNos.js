    ...
    <div id="sobrenos">
      ...
      <div className="flex justify-center">
        <div className="w-[90%] md:w-[70%] xl:h-[310vh] md:h-[430vh] bg-roxo rounded-3xl shadow-[0_35px_30px_-15px_rgba(0,0,0,0.3)]">
          ...
          <h2 className="text-5xl md:text-7xl text-branco text-center mx-auto font-calistoga py-10 md:py-20">{t("\nsobreNosTitulo2")}</h2>
          <h2 className="text-4xl md:text-6xl text-branco text-center mx-auto font-calistoga pt-10 md:py-20">{t("sobreNosTitulo3")}</h2>
          <div className="flex xl:flex-row flex-col justify-around items-center">
            ...
            <p className="text-branco text-xl text-center font-nunito w-[90%] md:w-[50%]">{t("sobreNosTexto3")}
            </p>
          </div>
          <h2 className="text-4xl md:text-6xl text-branco text-center mx-auto font-calistoga py-10 md:py-32">{t("sobreNosTitulo4")}</h2>
          <div className="flex justify-around items-center xl:flex-row flex-col">
            <p className="text-branco text-xl text-center font-nunito w-[90%] md:w-[50%]">{t("\nsobreNosTexto4")}<br /> <br /> {t("\nsobreNosTexto5")}
            </p>
