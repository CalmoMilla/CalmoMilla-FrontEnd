...
export default function SobreNos() {
  return (
    <>
      <h2 className="text-roxo text-7xl font-calistoga text-center py-20">Sobre nós</h2>
      <div className="flex justify-center">
        <div className="w-[70%] h-[220vh] bg-roxo rounded-3xl">
          ...
          <h2 className="text-7xl text-branco text-center mx-auto font-calistoga py-20">Identidade Visual</h2>
          <h2 className="text-6xl text-branco text-center mx-auto font-calistoga py-20">Paleta</h2>
          <div className="flex justify-around items-center">
            <Image width={500} height={500} src={"/assets/home/sobrenos/elementoscalmomilla.png"} alt=""/>
            <p className="text-branco text-xl text-center font-nunito w-[50%]">A paleta principal foi decidida com base em fotos de campos de flores, em especial a lavanda, planta com propriedades calmantes e relaxantes, com o objetivo de proporcionar aos usuários uma sensação de acolhimento, segurança e relaxamento.
            </p>
          </div>
          <h2 className="text-6xl text-branco text-center mx-auto font-calistoga py-32">Nome e Logo</h2>
          <div className="flex justify-around items-center">
