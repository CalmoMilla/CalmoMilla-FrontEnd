          ...
          <div className="w-[full] flex xl:justify-between xl:gap-20 items-center lg:flex-row flex-col pt-40">
            <div>
              <h1 className="font-calistoga xs:pb-8 xs:text-6xl md:text-[8rem] text-branco">
                Calmo<span className="text-amarelo1">Milla</span>
              </h1>
              <h2 className="font-calistoga xs:text-4xl md:text-6xl text-branco">
                <span className="text-amarelo1">{t("paginaInicial1")}</span>{" "}
                {t("paginaInicial2")}
                <br />
                {t("paginaInicial3")}
                <br />{" "}
