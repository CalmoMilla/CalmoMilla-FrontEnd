  ...
  return (
    <div className="w-full h-fit relative">
      <div className="w-[90%] md:w-[70%] h-fit relative mx-auto shadow-2xl rounded-xl">
        <h1 className="text-center text-7xl font-calistoga">{jogo && jogo[1]}</h1>
        <h2 className="text-center text-3xl font-nunito">Sua história e benefícios</h2>
        <Image src={jogo && jogo[2]} alt={"Imagem do Benefício"} width={800} height={800} className="mx-auto pt-12"/>
