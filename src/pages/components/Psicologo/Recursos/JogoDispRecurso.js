...
export default function JogoDispRecurso ({nome, funcao}) {
  return (
    <div className="w-[90%] h-60 shadow-2xl rounded-xl mx-auto">
      ...
      <div className="w-full h-[55%] py-2 px-5 flex flex-col justify-center gap-4">
        ...
        <button className="text-xl text-branco bg-roxo/70 hover:bg-roxo py-2 rounded-3xl hover:scale-110 hover:cursor-pointer duration-500 ease-in-out w-[70%]" onClick={funcao}>Ver benefícios</button>
      </div>
    </div>
  )
}