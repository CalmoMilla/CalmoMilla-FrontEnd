  ...
  return (
    <div className="w-full h-fit flex flex-col gap-4 mt-10">
      ...
      <div className="flex justify-between items-center my-5">
        ...
        <p className="font-nunito text-xl">{user.nome}</p>
      </div>
      <div className="flex justify-between items-center my-5">
        <p className="font-nunito text-xl">Data de Nascimento</p>
        <p className="font-nunito text-xl">{user.dataNasc[2] + "/" + user.dataNasc[1] + "/" + user.dataNasc[0]}</p>
      </div>
      <div className="flex justify-between items-center my-5">
        <p className="font-nunito text-xl">Gênero</p>
        <p className="font-nunito text-xl">{user.genero == "MASCULINO" ? "Masculino" 
