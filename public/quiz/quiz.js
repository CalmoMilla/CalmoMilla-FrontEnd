...
const questoes = pickRandomList(...listaPerguntas)
...
next_btn.onclick = ()=>{
    if(que_count < questoes.length - 1){ //if question count is less than total question length
...
function optionSelected(answer){
    ...
    let correcAns = questoes[que_count].answer; //getting correct answer from array
...
function queCounter(index){
    ...
    let totalQueCounTag = '<span><p>'+ index +'</p> de <p>'+ questoes.length +'</p></span>';
